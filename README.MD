...
In case of interpreted languages (ones not compiled to standalone executable) it is simply a process of:

1. Parsing the source code into AST (Abstract Syntax Tree).
